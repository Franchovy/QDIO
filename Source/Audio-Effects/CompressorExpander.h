...
class CompressorExpanderAudioProcessor : public BaseEffect
{
public:
    //==============================================================================
    ...
    AudioParameterFloat* paramThreshold;
    AudioParameterFloat* paramRatio;
    AudioParameterFloat* paramAttack;
    AudioParameterFloat* paramRelease;
    AudioParameterFloat* paramMakeupGain;
